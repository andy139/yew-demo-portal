...
export const metadata = {
  title: "The Kit | yew. payments",
  description:
    "Two pieces of software, one piece of hardware. The terminal is the only thing you have to buy from us.",
};
...
export default function Page() {
  return (
    <div className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="mt-16 grid md:grid-cols-3 gap-6">
        {panels.map((p, i) => (
          <Reveal key={p.title} delay={i * 90} threshold={0.15}>
            <div className="rounded-2xl border border-[color:var(--rule)] bg-white p-7 flex flex-col h-full">
      ...
      {/* Pre-built device — separate option */}
